...
// *** IMPORTANT: used by your feed to persist likes, comments, and bot replies
app.put('/api/posts/:id', (req, res) => {
  ...
  // Shallow merge is fine for our shape; arrays fully replace.
  data.posts[i] = {
    ...data.posts[i],
    ...incoming,
...
// ---- MESSAGES (simple) ----
// GET /api/messages?userId=...&peerId=...   (conversation between two users)
...
// Optional: a lightweight thread list for a user
